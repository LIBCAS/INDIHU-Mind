...
export const FileUploadPicker: React.FC<FileUploadPickerProps> = ({
  ...
  return (
    <>
      <div ref={AddAttributeRef} className={classes.fileUploadPickerWrapper}>
        <ButtonComponent onClick={onAddFile} />
        <AutoClosingPopper
          open={popperOpen}
              ...
              render={(formikBag: FormikProps<FileProps>) => (
                ...
                >
                  ...
                  <div className={classes.fileUploadPickerFormWrapper}>
                        ...
                        {formStage === "upload-options" && (
                          <>
                            ...
                            >
                              <DropboxChooser
                                appKey={
                                  process.env.REACT_APP_DROPBOX_KEY as string
                                }
                    ...
                    <div
                      className={classNames(
                        classes.fileUploadPickerActionWrapper,
                        {
