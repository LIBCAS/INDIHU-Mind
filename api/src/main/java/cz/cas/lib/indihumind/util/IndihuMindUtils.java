...
import static cz.cas.lib.indihumind.exception.ContentLengthRequiredException.ErrorCode.CONTENT_LENGTH_HEADER_MISSING;
import static cz.cas.lib.indihumind.exception.ForbiddenFileException.ErrorCode.FILE_FORBIDDEN;
