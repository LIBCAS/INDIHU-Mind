...
public class RefTemplateTestData implements TestDataRemovable {
    ...
    public ReferenceTemplate locationWithAuthor(User owner) {
        ...
        template.setFields(asList(
                new FieldAuthor(FirstNameFormat.FULL, MultipleAuthorsFormat.FULL, OrderFormat.FIRSTNAME_FIRST, Separator.COMMA, AndJoiner.CZECH_AND, Typeface.BOLD), new FieldComma(), new FieldSpace(),
    ...
    public ReferenceTemplate euroScience(User owner) {
        ...
        template.setFields(asList(
                ...
                new FieldAuthor(FirstNameFormat.FULL, MultipleAuthorsFormat.FULL, OrderFormat.FIRSTNAME_FIRST, Separator.DASH, AndJoiner.ENGLISH_AND, Typeface.ITALIC),
    ...
    public ReferenceTemplate authors(User owner) {
        ...
        template.setFields(asList(
                new FieldAuthor(FirstNameFormat.FULL, MultipleAuthorsFormat.FULL, OrderFormat.FIRSTNAME_FIRST, Separator.COMMA, AndJoiner.AMPERSAND, Typeface.UPPERCASE), new FieldComma(), new FieldSpace(),
    ...
    public ReferenceTemplate recordNameWithAuthors(User owner) {
        ...
        template.setFields(asList(
                ...
                new FieldAuthor(FirstNameFormat.FULL, MultipleAuthorsFormat.FULL, OrderFormat.FIRSTNAME_FIRST, Separator.DASH, AndJoiner.ENGLISH_AND, Typeface.BOLD),
    ...
    public ReferenceTemplate allFieldsTemplate(User owner) {
        ...
        template.setFields(asList(
                ...
                new FieldSpace(), new FieldAuthor(FirstNameFormat.FULL, MultipleAuthorsFormat.FULL, OrderFormat.FIRSTNAME_FIRST, Separator.COMMA, AndJoiner.CZECH_AND, Typeface.UPPERCASE),
