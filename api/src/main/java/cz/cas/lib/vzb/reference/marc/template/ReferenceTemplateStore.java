 ...
 */
@Repository
public class ReferenceTemplateStore extends IndexedNamedStore<ReferenceTemplate, QReferenceTemplate, IndexedReferenceTemplate> implements AdvancedSearchStore<IndexedReferenceTemplate> {
